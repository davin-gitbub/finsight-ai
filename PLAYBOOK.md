# cc-rig Playbook: standard + fastapi
...
### What's Active
  Agents: 8  |  Plugins: 5  |  Hooks: 9  |  Commands: 9
...
### Agents (8)
  ...
  python-reviewer     Sonnet    Python-specific code review with PEP compliance
  build-fixer         Sonnet    Build failure diagnosis and automated fix
  e2e-runner          Sonnet    End-to-end test execution and validation

### Plugins (5)
  pyright-lsp         Python type checking and diagnostics via Pyright
  github              GitHub integration (PRs, issues, actions)
  docker              Docker container management and Compose integration
